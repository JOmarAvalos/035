...
<header class="header">
    ...
    <nav class="navbar navbar-static-top" role="navigation" id="navHeader">
                        ...
                        <li>
                            ...
                            <ul class="menu">
                                ...
                                <li>
                                    <a href="#">
                                        <div class="pull-left">
                                            <img src="<c:url value='/resources/css/img/avatar2.png' />" class="img-circle" alt="user image"/>
                                        </div>
                                        <h4>
                                ...
                                <li>
                                    <a href="#">
                                        <div class="pull-left">
                                            <img src="<c:url value='/resources/css/img/avatar.png' />" class="img-circle" alt="user image"/>
                                        </div>
                                        <h4>
                                            Developers
