...
<script src="<c:url value='/resources/js/lms/plan/planCapacitacion.js' />" type="text/javascript"></script>
...
<main class="l-main">
    <nav aria-label="breadcrumb" role="navigation">
        <ol class="breadcrumb">
		    ...
		    <li class="breadcrumb-item active"><spring:message code="lms.planCapacitacion.plan.title" /></li>
        </ol>
    </nav>
    <div class="content-wrapper admin_wrap">
    
		<h1><spring:message code="lms.planCapacitacion.plan.title" /></h1>
                ...
                <div class="search_bar">
                	<c:if test="${not empty empresa}">
					    <c:if test="${!fn:contains(empresa, 'TOY')}">
		                    <input type="search" id="search_input_all" onkeyup="FilterkeyWord_all_table()" placeholder="<spring:message code="lms.planCapacitacion.placeholder.buscar" />"><span></span>
					    </c:if>
					    <c:if test="${fn:contains(empresa, 'TOY')}">
		                    <input type="search" id="search_input_all" onkeyup="FilterkeyWord_all_table()" placeholder="<spring:message code="lms.planCapacitacion.placeholder.buscar.toy" />"><span></span>
					    </c:if>
				    </c:if>
                </div>
            </div>
            ...
            <div class="col">
                <div class="table-responsive-sm">
                    <table class="table table-striped tabla-funcionarios" id= "table-cu">
                        <thead>
                            <tr>
                                <th class="text-left"><spring:message code="lms.planCapacitacion.table.nombre" /></th>
                                <th><spring:message code="lms.planCapacitacion.table.disribuidor" /></th>
                                <th><spring:message code="lms.planCapacitacion.table.puesto" /></th>
                                <th><spring:message code="lms.planCapacitacion.table.acciones" /></th>
                            </tr>
                        </thead>
                        <tbody>
							<c:if test="${not empty lstFuncionarios}">
								<c:forEach items="${lstFuncionarios}" var="funcionario">
		                            <tr>
		                                ...
		                                <td>
		                                    <a href="#" title="Editar" data-toggle="modal" onclick="getFuncionario('${funcionario.id}','${currentUser.funcionarioVO.id }');">
        ...
        <div class="row justify-content-center">
            ...
            <div class="col-12">
                <div class="rows_count"><spring:message code="lms.funcionarioslms.rows.count" /></div>
            </div>
        </div> 
        <!-- End Tabla -->
    </div>
...
<div class="modal fade edit-func" id="edit-funcionario">
	        	...
	        	<div id="divInfoFuncionarioCard">
	             ...
	             <div class="row">
	                 <div class="col-lg-4 col-sm-6 col-12">
	                     <p><span><spring:message code="lms.funcionarioslms.editar.puestos.table.dealer" />: </span></p><p id="pDistribuidor"></p>
	                 </div>
	                 <div class="col-lg-4 col-sm-6 col-12">
	                     <p id="pEmail">
	                     </p>
	                                             ...
	                                             <div class="tables-modal table-responsive-sm">
	                                                 <table class="table table-striped table-sm table-borderless">
	                                                     ...
	                                                     <tbody id="tbodyCursos">
	                                                         <tr>
	                                                             <td class="text-left">Curso basico</td>
	                                                             <td>01/07/2020</td>
	                                                             <td>8</td>
	                                                         </tr>
	                                                     </tbody>
	...
	<div class="col-md-3">
		<div class="form-group">
			<label><spring:message code="lms.funcionarioslms.editar.puesto.adic.label.puesto" /></label> <select class="form-control"
	id="selecPuestoAdicional">
	<option value="0"><spring:message code="lms.funcionarioslms.editar.puesto.adic.select" /></option>
