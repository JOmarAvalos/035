...
<aside class="right-side">
	...
	<section class="content-header">
		<h1>Motivos de Cancelaciones</h1>
	</section>
	...
	<section class="content">
		<div>
			<button class="btn btn-primary" onclick="newMotivoCancelacion();">Nuevo
				Motivo de Cancelación</button>
		</div>
		<br>
		<div>
			<a href="#" title="Descargar catálogo"
				onclick="descargarCatMotivosCancelaciones();"><i class="fa fa-file-excel-o"
							...
							<c:forEach items="${lstMotivosCancelacion}" var="cancelacion" varStatus="loop">
								<tr>
									...
									<td>
										...
										<a href="#" title="Ver" onclick="getMotivoCancelacion('${cancelacion.id}');"><i class="fa fa-cog"></i></a>&nbsp;
										
										<c:if test="${loop.count != 1}">
											<a href="#" title="Arriba" onclick="orderArribaMotivoCancelacion('${cancelacion.id}');"><i class="fa fa-arrow-circle-up"></i></a>&nbsp;
										</c:if>
				                    		
			                    		<c:if test="${loop.count != fn:length(lstMotivosCancelacion)}">
											<a href="#" title="Abajo" onclick="orderAbajoMotivoCancelacion('${cancelacion.id}');"><i class="fa fa-arrow-circle-down"></i></a>&nbsp;
										</c:if>
									</td>
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content bg-glass-sknd">
			...
			<form role="form" id="formMotivoCancelacion"
				action="javascript:saveMotivoCancelacion(this);" method="POST" class=""
							...
							<div class="row">
								<div class="col-md-12">
									<div class="form-group">
										...
										<input type="text" class="form-control" id="iptNombreMotivoCancelacion" maxlength="30"
											required="" placeholder="Motivo Cancelación (Español)">
										<input type="text" class="form-control" id="iptNombreMotivoCancelacionEn" maxlength="30"
											required="" placeholder="Motivo Cancelación (Inglés)">
										<input type="text" class="form-control" id="iptNombreMotivoCancelacionFr" maxlength="30"
