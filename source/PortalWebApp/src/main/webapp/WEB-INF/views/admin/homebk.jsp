	                     ...
	                     <table id="tblCuestionarios" class="table table-bordered table-striped">
	                         ...
	                         <tbody>
	                             <tr>
	                                 ...
	                                 <td>Resumen general de eventos traumáticos severos</td>
	                                 <td>Eventos traumáticos severos</td>
	                                 <td>$400.00</td>
	                                 <td>Disponible</td>
	                             </tr>
	                             <tr>
	                                 ...
	                                 <td>Hojas individuales de eventos traumáticos severos</td>
	                                 <td>Eventos traumáticos severos</td>
	                                 <td>$400.00</td>
	                                 <td>Disponible</td>
	                             </tr>
	                             ...
	                             <tr>
	                                 ...
	                                 <td>Resultado por área de trabajo y recomendaciones</td>
	                                 <td>Riesgos Psicosociales y Ambiente laboral</td>
	                                 <td>$2000.00</td>
	                                 <td>Disponible</td>
	                             </tr>
