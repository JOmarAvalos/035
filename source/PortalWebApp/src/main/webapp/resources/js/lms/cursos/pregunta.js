...
saveRespuesta = function(obj, idCurso, idActividad, idPregunta, idRespuesta) {
	validacionData = true;
	...
	if (validacionData) {
		...
		var urltxt = ctx + '/lms/actividad/saveRespuesta';
		...
		ActividadRespuestaVO.correcta = $('#selectRespuestaCorrecta').val();
...
orderArribaRespuesta = function(idCurso, idActividad, idPregunta, idRespuesta) {

	var urltxt = ctx + '/lms/actividad/changeOrdenArribaRespuesta?idPregunta='+idPregunta+'&idRespuesta='+idRespuesta;
...
orderAbajoRespuesta = function(idCurso, idActividad, idPregunta, idRespuesta) {

	var urltxt = ctx + '/lms/actividad/changeOrdenAbajoRespuesta?idPregunta='+idPregunta+'&idRespuesta='+idRespuesta;
...
estatusRespuesta = function(idCurso, idActividad, idPregunta, idRespuesta) {
...
estatusRespuestaConfirmacion = function() {
	...
	var urltxt = ctx + '/lms/actividad/changeEstatusRespuesta?id='+idRespuesta;
...
editRespuesta = function(idRespuesta) {
	...
	var urltxt = ctx + '/lms/actividad/consultaRespuesta?id='+idRespuesta;
