 ...
 */
package com.teknei.inventory.webapp.test.controller;

import org.junit.Test;
import org.springframework.http.MediaType;

import com.teknei.inventory.webapp.test.ControllerClientSideTestBase;
    ...
    public void test() throws Exception
    {
        this.mockMvc.perform(get("/student/1").contentType(MediaType.APPLICATION_JSON)
                .accept(MediaType.parseMediaType("application/json;charset=UTF-8"))).andExpect(status()
                        .isOk());
        System.out.println("Rugal Bernstein 2");
    }
}
